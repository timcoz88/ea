    ...
    <el-table v-loading="isLoading" :data="tableData" border style="width: 100%">
      ...
      <el-table-column align="center" label="操作" width="200">
        <template slot-scope="{ row, $index}">
          ...
          <el-button type="primary" size="mini" @click.native.prevent="goHandleRecord(row)">故障历史</el-button>
        </template>
      </el-table-column>
    </el-table>
...
export default {
  ...
  methods: {
    ...
    goHandleRecord(row) {
      console.log(row)
      this.$router.push({ name: 'handlerJxRecord', query: { host_ip: row.hostip, check_type: 3 }})
    }
  }
}
</script>
