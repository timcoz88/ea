  ...
  >
    ...
    >
      <el-form-item label="数据库名" prop="dbnm">
        <el-input v-model="componentForm.dbnm" style="width: 60%" placeholder="请输入数据库名"></el-input>
      </el-form-item>
      <el-form-item label="数据库ip" prop="hostip">
        <el-input v-model="componentForm.hostip" style="width: 60%" placeholder="请输入数据库ip"></el-input>
      </el-form-item>
      <el-form-item label="端口" prop="dbport">
        <el-input v-model="componentForm.dbport" style="width: 60%" placeholder="请输入端口"></el-input>
      </el-form-item>
      <el-form-item label="数据库服务名" prop="dsn">
        <el-input v-model="componentForm.dsn" style="width: 60%" placeholder="请输入数据库服务名"></el-input>
      </el-form-item>
      <el-form-item label="类型" prop="dbtype">
        <el-input v-model="componentForm.dbtype" style="width: 60%" placeholder="请输入类型"></el-input>
      </el-form-item>
      <el-form-item label="登录名" prop="dbuser">
        <el-input v-model="componentForm.dbuser" style="width: 60%" placeholder="请输入登录名"></el-input>
      </el-form-item>
      <el-form-item label="数据库架构" prop="clflag">
        <el-input v-model="componentForm.clflag" style="width: 60%" placeholder="请输入数据库架构"></el-input>
      </el-form-item>
      <el-form-item label="数据库版本" prop="dbver">
        <el-input v-model="componentForm.dbver" style="width: 60%" placeholder="请输入数据库版本"></el-input>
      </el-form-item>
